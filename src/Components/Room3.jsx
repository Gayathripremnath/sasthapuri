    ...
    <div className="rooms-page">
      ...
      <div className="rm-hero" style={{ backgroundImage: `url(${slide1})` }}>
        ...
        <div className="rm-hero-content anim anim-up">
          ...
          <h1 className="rm-hero-title">Double Room</h1>
        </div>
      </div>
      ...
      <section className="rm-rooms-section">
        <div className="rm-container">
          <div className="rm-room-card anim anim-left">
            <figure className="rm-room-fig"><img src={slide5} alt="Double Room" /></figure>
            <div className="rm-room-caption">
              <h3 className="rm-room-price">₹5,200 <span>/ Night</span></h3>
              <h4 className="rm-room-name">Double Room</h4>
              ...
              <div className="rm-facilities">
                <ul><li>👥 2-3 Persons</li><li>📶 Free Wifi</li></ul>
                <ul><li>🛏 Queen Bed</li><li>🍳 Breakfast</li></ul>
                <ul><li>📐 250 sqft Room</li><li>🏊 Swimming Pool</li></ul>
              </div>
