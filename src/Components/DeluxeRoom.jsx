...
const DeluxeRoom = () => {
    ...
    return (
        <div className="deluxe-room-page">
            ...
            {/* Hero Section */}
            <header className="dr-hero" style={{ backgroundImage: `url(${gal5})` }}>
                ...
                <div className="dr-container">
                    <div className="dr-grid">
                        <div className="dr-text anim anim-left">
                            ...
                            <div className="dr-policies-integrated" style={{ marginTop: '40px', paddingTop: '30px', borderTop: '1px solid #e8e0d5' }}>
                                <h4 style={{ fontFamily: "'Gilda Display', serif", fontSize: '24px', color: '#222', marginBottom: '20px' }}>Hotel Policies</h4>
                                <ul className="dr-policy-list" style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                        ...
                        <div className="dr-images anim anim-right">
                            <div className="dr-img-box main-img">
                                <img src={gal5} alt="Deluxe Room Interior" />
                            </div>
                            <div className="dr-img-box sub-img">
                                <img src={gal5} alt="Room View" />
                            </div>
                        </div>
                    </div>
                </div>
